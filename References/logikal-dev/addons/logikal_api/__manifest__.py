# -*- coding: utf-8 -*-
{
    ...
    'description': """
        ...
        This module provides comprehensive integration with the LOGIKAL API.
        ...
        * Folder, project, phase, and elevation synchronization
        * Master sync orchestration with background job processing
        * Exclude from Sync feature for performance optimization
        * Sales Order integration with MBIOE project import
